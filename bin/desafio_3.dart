...
Future<void> main() async {
  ...
  final palavra = await TermoGenerator.instance();
  print(palavra.pegacaracter());
...
class TermoGenerator {
  ...
  List<String>? pegacaracter() {
    final caracter = _termos;
    for (var element in caracter) {
      return element.split('');
    }
  }

  void verificaPalavra() {
    final palavra = _termos;
    final cornapalavra = ColorPrint();

    for (var element in palavra) {
      if (element == element) {}
    }
  }
